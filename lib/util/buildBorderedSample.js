...
<div class="docs-code-wrapper">
  ...
  <div class="docs-code docs-code-inky">
    <pre>
      <code class="{0}">{1}</code>
    </pre>
  </div>
...
<button class="docs-code-toggle" type="button" data-docs-code-toggle>Switch to bordered</button>

<iframe class="docs-code-iframe" src="examples/{3}" data-docs-code></iframe>
<iframe class="docs-code-iframe" src="examples/{4}" data-docs-code></iframe>

*/}).replace(/(^(\s)*|\n)/gm, '');

var REGULAR_IFRAME_TEMPLATE = multiline(function() {/*
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 <html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
   <head>
     <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
     <meta name="viewport" content="width=device-width">
     <title>Regular Wrapper</title>
   </head>
   <body>
...
var BORDERED_IFRAME_TEMPLATE = multiline(function() {/*
  <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
      <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
